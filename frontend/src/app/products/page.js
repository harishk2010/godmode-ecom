...
import { motion } from 'framer-motion';
import {
  RiFilterLine, RiSearchLine, RiCloseLine,
} from 'react-icons/ri';
import ShopLayout from '@/components/layout/ShopLayout';
import ProductCard from '@/components/products/ProductCard';
import { ProductCardSkeleton, Pagination, EmptyState } from '@/components/ui';
...
const CATEGORIES = [
  ...
  'Books', 'Beauty', 'Toys', 'Food', 'Automotive', 'Other',
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        {pagination.total > 0 && (
          <p className="text-white/40 text-sm mt-1">{pagination.total} products found</p>
        )}
      </div>
      ...
      <div className="flex gap-8">
              ...
              <div className="space-y-1">
                <button
                  ...
                  className={`w-full text-left text-sm px-3 py-2 rounded-lg transition-colors ${
                    !filters.category ? 'bg-orange-500/20 text-orange-400' : 'text-white/60 hover:text-white hover:bg-white/5'
                  }`}
                >
                  All Categories
                </button>
                {CATEGORIES.map((cat) => (
                  <button
                    ...
                    onClick={() => updateFilter('category', cat)}
                    className={`w-full text-left text-sm px-3 py-2 rounded-lg transition-colors ${
                      filters.category === cat ? 'bg-orange-500/20 text-orange-400' : 'text-white/60 hover:text-white hover:bg-white/5'
                    }`}
                  >
                    {cat}
                  </button>
        ...
        <div className="flex-1 min-w-0">
          ...
          {loading ? (
            ...
            <EmptyState icon={RiSearchLine} title="No products found"
